...
fn main() {
  ...
  No    Food Items                   
   1.   Poundo Yam & Edikaiko Soup  - N3200.00
   2.   Fried Rice & Chicken   - N3000.00
   3.   Amala & Ewedu Soup    - N2500.00
   4.   Eba & Egusi Soup      - N2000.00
   5.   White Rice & Stew     - N2500.00

  Orders above N10,000 get a 10% discount");

   let mut input1 = String::new();
   println!("Enter the no for what you would like to have: ");
